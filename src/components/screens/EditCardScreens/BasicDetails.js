...
const BasicDetails = ({editedCard,handleEditInputChange,handleEditSubmit}) => {
               ...
               <div className="basic-details-input-row">
                ...
                <div className="basic-details-input-row">
                    <div>
                        ...
                        <input className='basic-details-input' type="text" placeholder="Phone" name='phone' value={editedCard.phone} onChange={handleEditInputChange} />
                        </div>
                        <div>
                ...
                <div className='basic-details-buttons-flex'>
                    <button className='save-basic' onClick={handleEditSubmit}>
                        Sauvegarder
                    </button>
